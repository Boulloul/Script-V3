...
function fightManagementPosition(challengers, defenders)
    ...
    if fightCharacter:getMapid() == MAP_SALLE1 then
        ...
        if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then            local dofus_position=inventory:itemPosition(13765)
    ...
    if fightCharacter:getMapid() == MAP_SALLE2 then
        ...
        if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then            fightAction:chooseCell(STARTPLACEMENT_SALLE2_CRA1)
    ...
    if fightCharacter:getMapid() == MAP_SALLE3 then
        ...
        if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then            fightAction:chooseCell(STARTPLACEMENT_SALLE3_CRA1)
    ...
    if fightCharacter:getMapid() == MAP_SALLE4 then
        ...
        if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then            fightAction:chooseCell(STARTPLACEMENT_SALLE4_CRA1)
    ...
    if fightCharacter:getMapid() == MAP_SALLE5 then
        ...
        if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then            local dofus_position=inventory:itemPosition(8698)
...
function fightManagement()
    ...
    if fightCharacter:isItMyTurn() then
        if fightCharacter:getMapid() == MAP_SALLE5 then
            ...
            countEntityName()
            if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then                if fightAction:getCurrentTurn() == 1 then
           ...
           if fightCharacter:getId() == ACRA3_ID or fightCharacter:getId() == BCRA3_ID or fightCharacter:getId() == CCRA3_ID or fightCharacter:getId() == DCRA3_ID then
        ...
        if fightCharacter:getId() == ACRA4_ID or fightCharacter:getId() == BCRA4_ID or fightCharacter:getId() == CCRA4_ID or fightCharacter:getId() == DCRA4_ID then
            if fightAction:getCurrentTurn() == 1 then
                    local Comte_Harebourg,Nocturlabe,Sinistrofu,Strigideide,Granduk,Cycloide,Sapeur,Gobosteur = 0,0,0,0,0,0,0,0
                    local Comte_HarebourgID,NocturlabeID,SinistrofuID,StrigideideID,GrandukID,CycloideID,SapeurID,GobosteurID = 3416,3415,3414,3411,3410,3412,2933,2932
                    for _, entity in ipairs(fightAction:getAllEntities()) do
    ...
    if fightCharacter:isItMyTurn() then
        if fightCharacter:getMapid() == MAP_SALLE1 or fightCharacter:getMapid() == MAP_SALLE4 or fightCharacter:getMapid() == MAP_TEST then
            ...
            countEntityName()
            if fightCharacter:getId() == ACRA1_ID or fightCharacter:getId() == BCRA1_ID or fightCharacter:getId() == CCRA1_ID or fightCharacter:getId() == DCRA1_ID then                if (fightCharacter:isItMyTurn() == true) then
